        ...
        ZStack{
            NavigationView{
                List{
                    ...
                    NavigationLink(destination: ClarkeDaugherty()){
                        Text("Clarke Daugherty")
                    }
                    NavigationLink(destination: ShailaMiranda()){
                        Text("Shaila Miranda")
                    }
                    NavigationLink(destination: MatthewJensen()){
                        Text("Matthew Jensen")
                    }
                    NavigationLink(destination: TeresaShaft()){
                        Text("Teresa Shaft")
                    }
                    NavigationLink(destination: WilWu()){
                        Text("Wil Wu")
                    }
                    NavigationLink(destination: AlexandraDurcikova()){
                        Text("Alexandra Durcikova")
                    }
                    NavigationLink(destination: RajendraSingh()){
                        Text("Rajendra Singh")
                    }
                    NavigationLink(destination: JonathanYe()){
                        Text("Jonathan Ye")
                    }
                    NavigationLink(destination: BobBeatty()){
                        Text("Bob Beatty")
                    }
